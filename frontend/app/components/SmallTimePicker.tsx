...
export function SmallTimePicker({
  visible,
  onDismiss,
  onConfirm,
  hours,
  ...
  onDismiss: () => any;
  onConfirm: ( hours: number, minutes: number ) => any;
...
// const [localDay,setlocalDay] = React.useState(getDay(day))
...
export default React.memo(SmallTimePicker);
